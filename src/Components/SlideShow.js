      ...
      <Carousel className="my-3 shadow" >
        <Carousel.Item data-interval="10000">
          ...
          <div className="m-3 p-3 text-center aboutCompany align-content-center">
            Компания «Алем ойл» занимается оптовой и розничной реализацией нефтепродуктов в Восточно-Казахстанской области. Компания была основана в 2005 году под брендом "Бухтарма Ойл" на базе имущественного комплекса "Бухтарминская нефтебаза". В течение 10 лет основным видом деятельности являлись прием, хранение, отпуск нефтепродуктов и их оптовая реализация. С 2008 года по настоящее время генеральным директором компании является Зубов Сергей Леонидович.
          </div>
        </Carousel.Item>
        <Carousel.Item data-interval="10000">
          <img
